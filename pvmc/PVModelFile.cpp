...
{
  if((_file = fopen(pp_file,"wb"))==NULL)
    return OPEN_FILE;
...
{
  if((_file = fopen(pp_file,"rb"))==NULL)
    return OPEN_FILE;
  else 
    _atcloud = 0;
...
main(int pv_argc, char** pp_argv)
{
 ...
 printf("Size of Header:  %i\n",sizeof(PVModelFile::PVModelFileHeader));
 printf("Size of Cloud:  %i\n",sizeof(PVModelFile::PVModelFileCloud));
 printf("Size of Vector: %i\n",sizeof(PVModelFile::PVModelFileVector));
 printf("Size of Mask:   %i\n",sizeof(PVModelFile::PVModelFileMask));
